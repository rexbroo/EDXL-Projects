...
<sql:query var="reviewCategories" dataSource="jdbc/edxl_cap_v1_2_refimp">
    SELECT * FROM reviewCategory
</sql:query>
    
<sql:query var="selectedReviewCategory" dataSource="jdbc/edxl_cap_v1_2_refimp">
    SELECT name FROM reviewCategory WHERE id = ?
...
<sql:query var="elementDatatypes" dataSource="jdbc/edxl_cap_v1_2_refimp">
    ...
    <sql:param value="${pageContext.request.queryString}"/>
        ...
        <div id="edxlLeftColumn">
            <c:forEach var="reviewCategory" items="${reviewCategories.rows}">

                <c:choose>
                    <c:when test="${reviewCategory.id == pageContext.request.queryString}">
                        <div class="edxlButton" id="selectedReviewCategory">
                            <span class="edxlText">
                                ${reviewCategory.name}
                            </span>
                        </div>
                    ...
                    <c:otherwise>
                        <a href="reviewCategory?${reviewCategory.id}" class="edxlButton">
                            <div class="edxlText">
                                ${reviewCategory.name}
                            </div>
                        </a>
            ...
            <div id="edxlRightColumn">
                ...
                <p id="edxlCategoryTitle">${selectedReviewCategory.rows[0].name}</p>
